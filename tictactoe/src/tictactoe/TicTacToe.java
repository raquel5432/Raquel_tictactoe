...
public class TicTacToe {
    ...
    public TicTacToe() {
        ...
        playerX = JOptionPane.showInputDialog("Ingresa el nombre del jugador 1 (X):");
        playerO = JOptionPane.showInputDialog("Ingresa el nombre del jugador 2 (O):");
        ...
        // Etiqueta de estado
        statusLabel = new JLabel("Turno de " + playerX + "X", SwingConstants.CENTER);
    ...
    private void handleButtonClick(JButton button) {
        ...
        if (checkWinner()) {
            statusLabel.setText("¡Ganó " + (isXTurn ? playerX : playerO) + "!");
            disableButtons();
        } else if (isBoardFull()) {
            statusLabel.setText("¡Empate!");
        } else {
            isXTurn = !isXTurn; // Cambiar turno
            statusLabel.setText("Turno de " + (isXTurn ? playerX : playerO));
        }
    }
